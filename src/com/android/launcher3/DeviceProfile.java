...
public class DeviceProfile {
    ...
    public void updateInsets(Rect insets) {
        // All apps padding was derived from the insets when this profile was built, so carry the
        // change across instead of leaving it at whatever the insets were back then.
    ...
    public int getHotseatQsbWidth() {
        ...
        if (mHotseatProfile.isQsbInline()) {
            ...
            // Despite the name, this branch is the width of the hotseat row itself rather than
            // of the search bar, so it has to stay correct when the search bar is hidden.
